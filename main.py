...
Always be helpful and respond in the same language as the user's input."""
    ...
    def show_banner(self):
        ...
        banner_lines = [
            "",
            "  _  __ ____  _____ ____  ____  ____   ____ ___  ____  _____    ____  ____  _____ ",
            " | |/ /|  _ \\| ____|  _ \\/ ___||  _ \\ / ___/ _ \\|  _ \\| ____|  / ___|  _ \\|_   _|",
            " | ' / | |_) |  _| | | | | |  _ | | | | |  | | | | | | |  _|   | |  _| |_) | | |  ",
            " | . \\ |  _ <| |___| |_| | |_| || |_| | |__| |_| | |_| | |___  | |_| |  __/  | |  ",
            " |_|\\_\\|_| \\_\\_____|____/ \\____||____/ \\____\\___/|____/|_____|  \\____|_|     |_|  ",
            "",
